              ...
              for (; i2 < length; i2++) {
                ...
                for (name in options2) {
                  ...
                  if (Util2.isArray(copy) || Util2.isObject(copy)) {
                    if (Util2.isArray(copy)) clone = src && Util2.isArray(src) ? src : [];
                    if (Util2.isObject(copy)) clone = src && Util2.isObject(src) ? src : {};
          ...
          function(module2, exports2, __webpack_require__2) {
            ...
            module2.exports = {
              parse: function(name) {
                ...
                for (var r in result) {
                  if (result[r] != void 0) return result;
                }
                return {};
              }
            };
          ...
          function(module2, exports2) {
            ...
            var parser = function() {
              ...
              function u(n2) {
                ...
                function o(n3) {
                  var l2 = 0;
                  for (n3.sort(); l2 < n3.length; ) n3[l2 - 1] === n3[l2] ? n3.splice(l2, 1) : l2++;
                }
                function c() {
                  var l2, u3, t2, r2, o2;
                ...
                function i2() {
                  var n3, l2, u3, t2, r2;
                  if (n3 = qt, l2 = f(), null === l2 && (l2 = al), null !== l2) if (u3 = qt, Wt++, t2 = d(), Wt--, null === t2 ? u3 = al : (qt = u3, u3 = il), null !== u3) {
                    for (t2 = [], r2 = h(), null === r2 && (r2 = a()); null !== r2; ) t2.push(r2), r2 = h(), null === r2 && (r2 = a());
                ...
                function T() {
                  var l2, u3, t2;
                  if (l2 = qt, u3 = [], zl.test(n2.charAt(qt)) ? (t2 = n2.charAt(qt), qt++) : (t2 = null, 0 === Wt && e(Il)), null !== t2) for (; null !== t2; ) u3.push(t2), zl.test(n2.charAt(qt)) ? (t2 = n2.charAt(qt), qt++) : (t2 = null, 0 === Wt && e(Il));
                  else u3 = il;
                ...
                function Q() {
                  var l2, u3, t2, r2, o2;
                  if (Wt++, l2 = qt, 91 === n2.charCodeAt(qt) ? (u3 = iu, qt++) : (u3 = null, 0 === Wt && e(au)), null !== u3) if (94 === n2.charCodeAt(qt) ? (t2 = pl, qt++) : (t2 = null, 0 === Wt && e(vl)), null === t2 && (t2 = al), null !== t2) {
                    for (r2 = [], o2 = S(), null === o2 && (o2 = U()); null !== o2; ) r2.push(o2), o2 = S(), null === o2 && (o2 = U());
                ...
                function _() {
                  ...
                  if (l2 = qt, n2.substr(qt, 2) === Tt ? (u3 = Tt, qt += 2) : (u3 = null, 0 === Wt && e(xt)), null !== u3) {
                    if (t2 = [], yt.test(n2.charAt(qt)) ? (r2 = n2.charAt(qt), qt++) : (r2 = null, 0 === Wt && e(mt)), null !== r2) for (; null !== r2; ) t2.push(r2), yt.test(n2.charAt(qt)) ? (r2 = n2.charAt(qt), qt++) : (r2 = null, 0 === Wt && e(mt));
                    else t2 = il;
                ...
                function nl() {
                  ...
                  if (l2 = qt, n2.substr(qt, 2) === Ft ? (u3 = Ft, qt += 2) : (u3 = null, 0 === Wt && e(Qt)), null !== u3) {
                    if (t2 = [], St.test(n2.charAt(qt)) ? (r2 = n2.charAt(qt), qt++) : (r2 = null, 0 === Wt && e(Ut)), null !== r2) for (; null !== r2; ) t2.push(r2), St.test(n2.charAt(qt)) ? (r2 = n2.charAt(qt), qt++) : (r2 = null, 0 === Wt && e(Ut));
                    else t2 = il;
                ...
                if (Token.offset = t, Token.text = u2, rl = cl(), null !== rl && qt === n2.length) return rl;
                ...
                if (!rule.parameters) {
                  switch (templateType) {
                    case "regexp":
                      ...
                      return result.length === length;
                    case "string":
                      if (schema.template.match(Constant2.RE_PLACEHOLDER)) return result.length === length;
                      break;
                  }
